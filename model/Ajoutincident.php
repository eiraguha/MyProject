...
/**
 * Création des incidents via un formulaire 
 * 
 */
class Ajoutincident extends Model {

    /** Renvoie la liste des incidents
     * 
          */
    public function getAjoutincidents() {
     ...
     */
    public function getAjoutincident($id) {
     ...
     */
    public function EnregistrerAjoutincident()
    {
